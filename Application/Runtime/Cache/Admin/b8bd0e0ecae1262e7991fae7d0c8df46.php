                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_1">
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td>
                                                ...
                                                <?php
 echo md5(sha1(sha1($vo['password']))); ?>
                                            ...
                                            <td>
                                                ...
                                                <?php
 if($vo['admin'] == 0){ echo "普通用户"; } if($vo['admin'] == 999 || $vo['admin'] == 9999){ echo "管理员"; } ?>
                                            ...
                                            <td>
                                                ...
                                                <a href="index.php?&m=admin&a=personal&id=<?php echo ($vo["uid"]); ?>" class="btn green btn-xs update">
                                                    修改
                                                </a>

                                                <a href="index.php?&m=admin&a=set_admin&id=<?php echo ($vo["uid"]); ?>" class="btn green btn-xs ">
                                                    设置管理员
                                                </a>

                                                <a href="index.php?&m=admin&a=cansel_admin&id=<?php echo ($vo["uid"]); ?>" class="btn green btn-xs ">
                                                    取消管理员
                                                </a>


                                                <button type="button" data-id="<?php echo ($vo["uid"]); ?>" class="btn green btn-xs delete">
                                                    删除
                                                </button>
...
//           onclick="window.location.href='index.php?&m=admin&a=delete_article&id=<?php echo ($vo["id"]); ?>';"
        ...
        $("#delete_confirm").click(function () {
            ...
            console.log(iid);
            window.location.href='index.php?&m=admin&a=delete_admin&id='+iid;
//            href="index.php?&m=admin&a=delete_admin&id=<?php echo ($vo["uid"]); ?>"
        });
