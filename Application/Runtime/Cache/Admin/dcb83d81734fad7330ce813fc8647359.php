...
<div class="page-wrapper">
    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 0px">
            ...
            <!--</li>-->
            <li class="nav-item start<?php if(admin == 'news'){ echo ' active open';} ?>">
                ...
                <ul class="sub-menu">
                    <li class="nav-item start<?php if(admin == 'news' && admin=='news'){ echo ' active open';} ?>">
                        <a href="index.php?&m=admin&a=news" class="nav-link ">
                            <i class="icon-bar-chart"></i>
                            <span class="title">文章列表</span>
                        </a>
                    </li>
                    <li class="nav-item start <?php if(admin == 'news' && admin=='add_article'){ echo ' active open';} ?>">
            ...
            <li class="nav-item start <?php if(admin == 'admin'){ echo ' active open';} ?>" style="">
                <a href="javascript:;" class="nav-link nav-toggle">
                ...
                <ul class="sub-menu">
                    <li class="nav-item   <?php if(admin == 'admin' && admin=='admin'){ echo ' active open';} ?>">
            ...
            <li class="nav-item  <?php if(admin == 'user'){ echo ' active open';} ?>" style="">
                <a href="javascript:;" class="nav-link nav-toggle">
                    <i class="icon-briefcase"></i>
                ...
                <ul class="sub-menu">
                    <li class="nav-item   <?php if(admin == 'user' && admin=='user'){ echo ' active open';} ?>">
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>
                            <a href="index.php?&m=admin&a=admin">管理员</a>
                            <i class="fa fa-circle"></i>
                        </li>
                        <li>
                            <a href="index.php?&m=admin&a=admin">管理员列表</a>
                            <i class="fa fa-circle"></i>
                        </li>
                        <li>
                            <span>个人信息</span>
                    ...
                    <div class="col-md-6 ">
                        ...
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body form">
                                <form class="form-horizontal" action="index.php?&m=admin&a=personal_msg" method="post" role="form">



                                    <input type="hidden" name="uid" value="<?php echo ($admin["uid"]); ?>" class="form-control input-inline input-medium" >

                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">用户名</label>
                                            <div class="col-md-9">
                                                <input type="text" name="user_name" id="user_name" disabled="disabled"  value="<?php echo ($admin["user_name"]); ?>" class="form-control input-inline input-medium" placeholder="请输入用户名">
                                                <!--<span class="help-block"> A block of help text. </span>-->
                                                <button id="alter_user_name" type="button" class="btn green">修改用户名</button>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="password" name="password" id="password" disabled="disabled" value="<?php echo ($admin["password"]); ?>" class="form-control input-inline input-medium" placeholder="请输入新密码">
                                                <!--<span class="help-inline"> 修改密码 </span>-->
                                                <button id="alter_password" type="button" class="btn green">修改密码</button>
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                ...
                                                <a href="index.php?&m=admin&a=admin" class="btn default">取消</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#alter_user_name").click(function () {
//            $("#user_name").val("");
