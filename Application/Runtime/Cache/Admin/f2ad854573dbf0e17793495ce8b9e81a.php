...
<div class="page-wrapper">
    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 0px">
            ...
            <!--</li>-->
            <li class="nav-item start<?php if(user == 'news'){ echo ' active open';} ?>">
                ...
                <ul class="sub-menu">
                    <li class="nav-item start<?php if(user == 'news' && user=='news'){ echo ' active open';} ?>">
                        <a href="index.php?&m=admin&a=news" class="nav-link ">
                            <i class="icon-bar-chart"></i>
                            <span class="title">文章列表</span>
                        </a>
                    </li>
                    <li class="nav-item start <?php if(user == 'news' && user=='add_article'){ echo ' active open';} ?>">
            ...
            <li class="nav-item start <?php if(user == 'admin'){ echo ' active open';} ?>" style="">
                <a href="javascript:;" class="nav-link nav-toggle">
                ...
                <ul class="sub-menu">
                    <li class="nav-item   <?php if(user == 'admin' && user=='admin'){ echo ' active open';} ?>">
            ...
            <li class="nav-item  <?php if(user == 'user'){ echo ' active open';} ?>" style="">
                <a href="javascript:;" class="nav-link nav-toggle">
                    <i class="icon-briefcase"></i>
                ...
                <ul class="sub-menu">
                    <li class="nav-item   <?php if(user == 'user' && user=='user'){ echo ' active open';} ?>">
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>
                            <a href="index.php?&m=admin&a=user">用户管理</a>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_1">
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td>
                                                ...
                                                <?php
 echo sha1(md5(sha1(sha1($vo['password'])))); ?>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#delete_confirm").click(function () {
            ...
            window.location.href='index.php?&m=admin&a=delete_user&id='+iid;
