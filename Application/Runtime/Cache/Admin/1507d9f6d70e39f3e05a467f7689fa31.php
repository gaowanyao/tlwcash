...
<head>
    ...
    <link href="/Public/resource/global/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css" rel="stylesheet" type="text/css" />
    <link href="/Public/resource/global/plugins/typeahead/typeahead.css" rel="stylesheet" type="text/css" />
    <!-- END PAGE LEVEL PLUGINS -->
    <link href="/Public/resource/global/plugins/bootstrap-select/css/bootstrap-select.min.css" rel="stylesheet" type="text/css" />
    <!-- END PAGE LEVEL PLUGINS -->
    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 0px">
            ...
            <li class="nav-item start<?php if(news == 'news'){ echo ' active open';} ?>">
                ...
                <ul class="sub-menu">
                    <li class="nav-item start<?php if(news == 'news' && add_article=='news'){ echo ' active open';} ?>">
                        <a href="index.php?&m=admin&a=news" class="nav-link ">
                            <i class="icon-bar-chart"></i>
                            <span class="title">文章列表</span>
                        </a>
                    </li>
                    <li class="nav-item start <?php if(news == 'news' && add_article=='add_article'){ echo ' active open';} ?>">
            ...
            <li class="nav-item start <?php if(news == 'admin'){ echo ' active open';} ?>" style="">
                ...
                <ul class="sub-menu">
                    <li class="nav-item   <?php if(news == 'admin' && add_article=='admin'){ echo ' active open';} ?>">
            ...
            <li class="nav-item  <?php if(news == 'user'){ echo ' active open';} ?>" style="">
                ...
                <ul class="sub-menu">
                    <li class="nav-item   <?php if(news == 'user' && add_article=='user'){ echo ' active open';} ?>">
                        ...
                        <div class="portlet light form-fit bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-green sbold uppercase">新增文章</span>
                                </div>
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="index.php?&m=admin&a=update_article_msg" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" value="<?php echo ($article["title"]); ?>" class="form-control" maxlength="25" name="title" id="title" placeholder="请输入标题">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" value="<?php echo ($article["author"]); ?>" class="form-control" maxlength="25" name="author" id="author" placeholder="请输入作者">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <select name="type" class="bs-select form-control">
                                                    <option <?php if($article['type'] == "众筹资讯"){ echo "selected"; } ?>>众筹资讯</option>
                                                    <option <?php if($article['type'] == "行业新闻"){ echo "selected"; } ?>>行业新闻</option>
                                                    <option <?php if($article['type'] == "媒体报道"){ echo "selected"; } ?>>媒体报道</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <select id="tag"  multiple data-role="tagsinput">
                                                    ...
                                                    <?php
 $tag = $article['tag']; $arr = explode(",",$tag); $str = ""; for($i=0;$i<count($arr);$i++){ if($arr[$i] == ''){}else{ $str .= "<option value='".$arr[$i]."'>".$arr[$i]."</option>"; } } echo $str; ?>
                                            ...
                                            <div class="col-md-9">
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail" style="width: 100px; height: 100px;">
                                                        <img src="<?php if($article['article_picture'] == ''){ echo 'http://www.placehold.it/100x100/EFEFEF/AAAAAA&amp;text=no+image';}else{echo $article['article_picture'];} ?>" onerror="javascript:this.src='http://www.placehold.it/100x100/EFEFEF/AAAAAA&amp;text=no+image';" alt="" /> </div>
                                                ...
                                                <div class="clearfix margin-top-10">
                                                    <span class="label label-danger">NOTE!</span>图像预览只能在IE10 +，ff3.6 +，safari6.0 +，chrome6.0 +，opera11.1 +,在较旧的浏览器中，只显示文件名，图片大小为100*100。<br/>
                                                    Image preview only works in IE10+, FF3.6+, Safari6.0+, Chrome6.0+ and Opera11.1+. In older browsers the filename is shown instead,the picture size is 100*100.
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                ...
                                                <button id="submit" type="submit" style="display: none;" class="btn btn-outline grey-salsa">重置</button>
...
<script src="/Public/resource/global/plugins/bootstrap-maxlength/bootstrap-maxlength.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<script src="/Public/resource/global/plugins/bootstrap-tagsinput/bootstrap-tagsinput.min.js" type="text/javascript"></script>
<script src="/Public/resource/global/plugins/typeahead/handlebars.min.js" type="text/javascript"></script>
<script src="/Public/resource/global/plugins/typeahead/typeahead.bundle.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN THEME GLOBAL SCRIPTS -->
<script src="/Public/resource/global/scripts/app.min.js" type="text/javascript"></script>
<!-- END THEME GLOBAL SCRIPTS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="/Public/resource/pages/scripts/components-bootstrap-tagsinput.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script src="/Public/resource/pages/scripts/components-bootstrap-maxlength.min.js" type="text/javascript"></script>

<!-- BEGIN PAGE LEVEL PLUGINS -->
<script src="/Public/resource/global/plugins/bootstrap-select/js/bootstrap-select.min.js" type="text/javascript"></script>

<!-- BEGIN THEME GLOBAL SCRIPTS -->
<script src="/Public/resource/global/scripts/app.min.js" type="text/javascript"></script>
<!-- END THEME GLOBAL SCRIPTS -->

<script src="/Public/resource/pages/scripts/components-bootstrap-select.min.js" type="text/javascript"></script>
