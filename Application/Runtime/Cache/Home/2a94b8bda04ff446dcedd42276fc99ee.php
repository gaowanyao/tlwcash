...
<head>
    <title><?php echo (L("_Index_title_1")); ?></title>
    <meta name="keywords" content="铜锣湾基金,Tcash,区块链金融,数字货币,区块链金融服务,区块链金融理财,比特币交易" />
...
<!--<div class="suspend">-->
    <!--<dl>-->
        <!--<dt class="IE6PNG"></dt>-->
        <!--<dd class="suspendQQ"><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=3283719599&site=qq&menu=yes"></a></dd>-->
        ...
        <div class="container text-center">
            ...
            <p style="<?php if($pc=='pc'){ echo 'margin-top: -30px;';}else{ echo 'margin-top: -10px;';}?>">
                ...
                <div style=" display: inline-block; text-align:justify;  <?php if($pc == 'pc'){ echo 'width: 42%;';}else{echo 'display: none;';} ?>" >
                  ...
                  <br/>
                <!--<a id="crowdFunding" style="display: inline-block;<?php if($pc == 'pc'){ echo 'margin-top: 5px';}else{echo 'margin-top: -45px;width:180px;';} ?> " class="btn btn-cta btn-cta-primary" target="_blank" onclick="_maxmin()" ><?php echo (L("_crowd_funding")); ?></a>-->
                    ...
                    <div class="desc notpc_center" style="margin-bottom: 0px;">
                        ...
                        <p class="notpc_center" style="display: inline-block;">
                            <p class="notpc_center" style="display: inline-block;">
                                ...
                                <!--<a class="btn btn-cta btn-cta-primary btn-ghost" style="width: 150px;background: #304153;" href="https://fir.im/hnp1?utm_source=fir&utm_medium=qr"><i class="fa fa-windows"></i><span class="text"><?php echo (L("_Index_pc_download")); ?></span></a>-->
                        <a class="btn btn-cta btn-cta-primary btn-ghost" style="width: 150px;background: #304153;" href=""><i class="fa fa-apple"></i><span class="text" ><?php echo (L("_Index_ios_download")); ?></span></a><br/>
                        <a class="btn btn-cta btn-cta-primary btn-ghost" style="width: 150px;background: #304153;" href=""><i class="fa fa-android"></i><span class="text"><?php echo (L("_Index_android_download")); ?></span></a><br/>
                        <a class="btn btn-cta btn-cta-primary btn-ghost" style="width: 150px;background: #304153;" href=""><i class="fa fa-windows"></i><span class="text"><?php echo (L("_Index_pc_download")); ?></span></a>
                ...
                <div class="carousel-inner" style="padding-bottom: 0px;margin-bottom: 0px;">
                    <div class="item active" style="padding-bottom: 0px;margin-bottom: 0px;">
                        ...
                        <div class="content">
                            ...
                            <p class="source"><?php echo (L("_Index_team_name1")); ?><br /><span class="title"><?php echo (L("_Index_team_name1_1")); ?></span></p>
                        </div><!--//content-->
                    </div><!--//item-->
                    ...
                    <div class="item " >
                        ...
                        <div class="content">
                            ...
                            <p class="source"><?php echo (L("_Index_team_name2")); ?><br /><span class="title"><?php echo (L("_Index_team_name2_2")); ?></span></p>
                        </div><!--//content-->
                    </div><!--//item-->
                    ...
                    <!--<div class="item " >-->
                        ...
                        <!--<div class="content">-->
                            <!--<blockquote>-->
                                <!--<i class="fa fa-quote-left"></i>-->
                                <!--<p><?php echo (L("_Index_team_content4")); ?></p>-->
                            <!--</blockquote>-->
                            <!--<p class="source"><?php echo (L("_Index_team_name4")); ?><br /><span class="title"><?php echo (L("_Index_team_name2_4")); ?></span></p>-->
                        <!--</div>&lt;!&ndash;//content&ndash;&gt;-->
                    <!--</div>&lt;!&ndash;//item&ndash;&gt;-->


                    <!--<div class="item " >-->
                        <!--<figure class="profile"><img style="width: 140px;height: 140px;border-radius: 100%" src="/Public/images/6.png" alt="" /></figure>-->
                        <!--<div class="content">-->
                            <!--<blockquote>-->
                                <!--<i class="fa fa-quote-left"></i>-->
                                <!--<p><?php echo (L("_Index_team_content5")); ?></p>-->
                            <!--</blockquote>-->
                            <!--<p class="source"><?php echo (L("_Index_team_name5")); ?><br /><span class="title"><?php echo (L("_Index_team_name2_5")); ?></span></p>-->
                        <!--</div>&lt;!&ndash;//content&ndash;&gt;-->
                    <!--</div>&lt;!&ndash;//item&ndash;&gt;-->
