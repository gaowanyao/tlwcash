...
<head>
    <title>新闻资讯-多宝金豆专注于区块链去中心化数字货币</title>
    <meta charset="utf-8">
    <!--[if IE]>
...
<style>
    ...
    .hidden_nav_li{
    <?php if($pc == 'notpc'|| news == 'index'){ echo 'display: none !important;';};?>
    }
    ...
    .display{
    <?php if('news' != 'home'){ echo 'display: none !important;';};?>
...
<header id="header" style="background: #000000;opacity: 0.9;">
    <div class="container" style=" <?php if($pc == 'pc'){ echo 'min-width: 1200px !important;';};?>">
        ...
        <nav class="nav_my" style="display: inline-block;float: right;">
            <ul class="menu_my_nav">
                ...
                <!--<li><a href="index.php" class="<?php if(news == 'index'){ echo 'active';} ?>">Home</a></li>-->
                <!--<li><a href="index.php?&a=news" class="<?php if(news == 'news'){ echo 'active';} ?>">News</a></li>-->
    ...
    <!--&lt;!&ndash;<li><a href="index.php" class="<?php if(news == 'index'){ echo 'active';} ?>">Home</a></li>&ndash;&gt;-->
    <!--&lt;!&ndash;<li><a href="index.php?&a=news" class="<?php if(news == 'news'){ echo 'active';} ?>">News</a></li>&ndash;&gt;-->
...
<script>
    ...
    <section id="intro-image" class="intro medium clearfix">
        ...
        <div class="intro-captions">
            <h3 class="caption-title big animated"><?php echo (L("_Header_news")); ?></h3><br>
            <h3 class="caption-title small animated"><?php echo (L("_News_small_title")); ?></h3>
        </div>

        <!-- Image -->
        <div class="image zoom news-intro" style="background-image:url(/Public/img/new/news.jpg) !important;"></div>
    ...
    <section id="content"  style="margin-top:-60px;">
        ...
        <!-- ############################# News Entries ############################# -->
        <section id="news-entries">



            <?php if(is_array($tag)): $i = 0; $__LIST__ = $tag;if( count($__LIST__)==0 ) : echo "当前页没有内容" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!-- Entry -->
                    ...
                    <div class="container">
                        <div class="col-1-3 entry-date">
                            <span class="date">
                                ...
                                <?php
 $time = strtotime($vo['create_time']); echo date("M d,Y",$time); ?>


                            </span>
                            <div class="categories"><a href="#"><?php echo (L("_DBCoin")); ?></a></div>
                        </div>

                        <div class="col-2-3 last">
                            <h2 class="entry-title"><a href="index.php?a=newsdet&id=<?php echo ($vo["id"]); ?>"><?php echo Translate::exec ( $vo['title'],"zh",$to); ?></a></h2>
                            <!--<p class="excerpt">-->
                            <!--Evolve, "drive 24/365 platforms vortals, platforms reinvent mashups niches dot-com." Holistic implement best-of-breed weblogs podcasts remix; share, data-driven blogospheres design generate leading-edge cross-platform, reinvent long-tail sticky solutions portals...-->
                            <!--</p>-->

                            <div class="animated" data-delay="100" style="height:100px;overflow: hidden;"><?php echo Translate::exec ( cutstr_html($vo['content'],200),"zh",$to); ?></div>


                            <span class=" animated"  style="color:#a0a9b4 !important;font-size: 16px;padding-bottom: 10px;" data-delay="150"><?php echo (L("_Tag")); ?>：</span><?php
 $tag = $vo['tag']; $arr = explode(",",$tag); $str = ""; for($i=0;$i<count($arr);$i++){ if($arr[$i] == ''){}else{ $str .='<a class="title_head animated" data-delay="200" style="color:#a0a9b4 !important;margin-right:5px;margin-bottom:5px;display:inline-block;" href="index.php?&a=tag&tag='.$arr[$i].'" >
                                                                        <span  >'.Translate::exec ( $arr[$i],"zh",$to).'</span>
                                                                        </a>'; } } echo $str; ?>

                            <!-- Button -->
                            <!--<a  style="margin-top:30px;"  class=" animated"  data-delay="200"><?php echo ($two[0]['create_time']); ?></a>-->
                            <div style="display: inline-block;text-align: right;float: right;padding-right: 10px;">
                                <a href="index.php?a=newsdet&id=<?php echo ($vo["id"]); ?>"  class="readmore animated"><?php echo (L("_News_read_more")); ?></a>
                ...
                <!-- /entry --><?php endforeach; endif; else: echo "当前页没有内容" ;endif; ?>
            ...
            <!--<div class="categories"><a href="#">Movies</a></div>-->
            <!--</div>-->

            <!--<div class="col-2-3 last">-->
            <!--<h2 class="entry-title"><a href="news-single.html">Using typography in design.</a></h2>-->
            <!--<div class="video-wrap">-->
            <!--&lt;!&ndash;-->
            <!--<iframe src="/Public/wap///player.vimeo.com/video/9178386?title=0&amp;byline=0&amp;portrait=0&amp;color=e96247" width="770" height="511" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>-->
            <!--&ndash;&gt;-->
            <!--<iframe height=511 width=770 src='http://player.youku.com/embed/XMjMwNTg0NDU2' frameborder=0 'allowfullscreen' webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>-->
            <!--</div>-->
            <!--<a href="news-single.html" class="readmore">Read Article</a>-->
        ...
        <div id="news_page" style="text-align: center!important; font-size: 20px !important;padding-top:0px;padding-bottom: 40px;width: 100%;">
            <?php echo ($showtag); ?>
