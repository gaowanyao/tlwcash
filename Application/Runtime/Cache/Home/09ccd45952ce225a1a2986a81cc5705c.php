...
<head>
    <meta charset="utf-8" />
    <title>关于我们-多宝金豆专注于区块链去中心化数字货币</title>
    <meta name="keywords" content="关于我们,多宝,金豆,多宝金豆,区块链,数字货币">
...
<style>
    ...
    .nav_my{
        ...
        display:inline-block;
         ...
         <?php if($pc == 'pc'){ echo 'margin-right:10px;';}else{ if('account' == 'account'){ echo 'margin-right: -5px;'; }else{ echo 'margin-right: 10px;';}}?>
    }
    ...
    .hidden_nav_li{
       <?php if($pc == 'notpc'|| about == 'index'){ echo 'display: none !important;';};?>
    }
   ...
   .login a:hover,.register a:hover,.logout a:hover{
    ...
    .display{
    <?php if('about' != 'home'){ echo 'display: none !important;';};?>
    ...
    <div class="container" style=" <?php if($pc == 'pc'){ echo 'min-width: 1200px !important;';};?>">
        ...
        <nav class="nav_my" style="display: inline-block;float: right;">
          ...
          <!---->
            ...
            <!--<li><a href="index.php" class="<?php if(about == 'index'){ echo 'active';} ?>">Home</a></li>-->
            <!--<li><a href="index.php?&a=news" class="<?php if(about == 'news'){ echo 'active';} ?>">News</a></li>-->
        ...
        <!--<div class="container">-->
            ...
            <!--<nav id="nav">-->
                <!--<ul>-->
                    ...
                    <!--&lt;!&ndash;<li><a href="index.php" class="<?php if(about == 'index'){ echo 'active';} ?>">Home</a></li>&ndash;&gt;-->
                    <!--&lt;!&ndash;<li><a href="index.php?&a=news" class="<?php if(about == 'news'){ echo 'active';} ?>">News</a></li>&ndash;&gt;-->
...
<section id="intro-image" class="intro medium clearfix">
    ...
    <!-- Image -->
    <div class="image zoom news-intro" style="background-image:url(/Public/img/new/aboutme2.jpg) !important;"></div>
    ...
    <div class="page-wrapper-row full-height" >
        <div class="page-wrapper-middle">
            <!-- BEGIN CONTAINER -->
            <!--style="<?php if($pc == 'notpc'){ echo 'margin-top: 58px !important;';} else{echo 'margin-top: 65px !important;';}?>"-->
            <div class="page-container" >
                ...
                <div class="page-content-wrapper">
                    ...
                    <!--<img  style="<?php if($pc == 'notpc'){ echo 'height:180px;';} else{echo 'height: 400px;';}?>width: 100%; " src="/Public/img/new/aboutme.jpg">-->


                    <!--</div>-->

                    <!-- BEGIN PAGE CONTENT BODY -->
                    <div class="page-content"  style=" <?php if($pc == 'notpc'){ echo 'margin-top: 20px;';} else{echo '';}?>">
                        <div class="container" >
    ...
    <div class="portlet light profile-sidebar-portlet radius">
        ...
        <div class="profile-usermenu" style="margin-top: 0px;">
            ...
            <ul class="nav hidden_nav" style="<?php if($pc == 'notpc'){ echo 'display:block;';} ?>">
                <li class="<?php if('about' == 'about'){ echo 'active';} ?>">
                ...
                <li class="<?php if('about' == 'newuserzc'){ echo 'active';} ?>">
                ...
                <!--<li class=" ">-->
                    ...
                    <!--</a>-->
                <!--</li>-->
                <li class="<?php if('about' == 'helpcenter'){ echo 'active';} ?>">
        ...
        <div class="profile-usermenu " style="margin-top: 0px;">
            ...
            <ul class="nav hidden_nav" style="<?php if($pc == 'notpc'){ echo 'display:block;';} ?>">
                <li class="<?php if('about' == 'signupguide'){ echo 'active';} ?>">
                ...
                <li class="<?php if('about' == 'rechargeguide'){ echo 'active';} ?>">
                    <a href="index.php?&a=rechargeguide">
                        <!--<i class="icon-settings"></i>-->
                        充值指南
                    </a>
                </li>
                <li class="<?php if('about' == 'tradingguide'){ echo 'active';} ?>">
                                                    ...
                                                    <div class="portlet light radius">
                                                        <div class="portlet-title tabbable-line" style="height: 60px;">
                                                            <div class="caption caption-md">
                                                                ...
                                                                <span class="caption-subject font-blue-madison bold uppercase" style="font-size: 20px;padding-left: 0px;">多宝金豆简介</span>
                                                            </div>
                                                        ...
                                                        <div class="portlet-body">
                                                            <div class="tab-content">
                                                                ...
                                                                <div class="tab-pane active" id="tab_1_1">
                                                                    ...
                                                                    <p class="dark indend ">多宝金豆是逊和集团有限公司消费金融经营方式中实现用户获得金融收益的一种数字货币资产，是逊和集团依据自身的资金和资产，通过资产转化方式形成的一种数字资产，全球限量6000万个，用户通过公司赠送和公司兑换获得多宝金豆，拥有多宝金豆即等于持有等值集团资产包份额。目前开通了抵押、贷款、担保、兑换、变现、增值、置换、交易、众筹等商业应用。加入逊和集团多宝互联平台，拥有多宝金豆让您的消费变成理财，让消费者成为企业的股东，实现财富共享。</p>
                                                                    <p class="dark indend distance">逊和集团旗下鑫烨（香港）电子商务有限公司，在香港开通多宝金豆交易大盘（届时多宝金豆由中心化运营方式更新为去中心化运营方式，基本类同比特币运营方式），拟定在2018年上半年进入香港创新板资本市场。鉴于此公司在7月15日至8月31日期间先在多宝互联平台开通多宝金豆用户间交易平台功能。</p>
                                                                    <p class="dark indend distance">逊和集团以“增值消费、全员持股、金融强国”作为企业经营方针，在全国率先推出了积分资产化的经营理念，有效的把企业和社会中的各种形式积分整合成一种多功能性资产“多宝金豆”，让持有多宝金豆的用户在合作中利益最大化。</p>
                                                                    <p class="dark indend distance">多宝金豆是网络一种虚拟数字货币，用来在多宝铺子提供支持商品购买交易通用数字货币，多宝金豆核心技术是在区块链上去中心化实现记账，用户无论通过法币或比特币、莱特币还是以太币等数字货币进行充值、兑换、交易、消费都可以换成等值比例多宝金豆。</p>
...
<script>
    ...
    $("#pwd_submit").click(function () {
        ...
        if(new_pwd == ""){
            ...
            $("#pwd_modal_body").html("请输入新密码");
            $("#pwd_modal").modal("show");
            return false;

        }

        if(rpassword != new_pwd){

            $("#pwd_modal_body").html("新密码与确认密码必须相同");
            $("#pwd_modal").modal("show");
            return false;

        }

        if(jmz.GetLength(old_pwd) < 6){
            $("#pwd_modal_body").html("旧密码长度不能小于6位");
            $("#pwd_modal").modal("show");
            return false;
        }
        if(jmz.GetLength(new_pwd) < 6){
            $("#pwd_modal_body").html("新密码长度不能小于6位");
            $("#pwd_modal").modal("show");
            return false;
        }

//        console.log(jmz.GetLength(new_pwd));
//        console.log(jmz.GetLength(new_pwd));
//        console.log(jmz.GetLength(new_pwd));
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        ...
                        success:function (data) {
                            ...
                            if(data == 1){
                                $("#modal_body").html("保存成功");
                                $("#basic").modal("show");
                            }

                            if(data == 2){
                                $("#modal_body").html("保存失败");
                                $("#basic").modal("show");
                            }
