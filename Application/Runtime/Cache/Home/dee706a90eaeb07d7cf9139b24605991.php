    ...
    <div class="portlet light profile-sidebar-portlet radius">
        ...
        <div class="profile-usermenu" style="margin-top: 0px;">
            ...
            <ul class="nav hidden_nav" style="<?php if($pc == 'notpc'){ echo 'display:block;';} ?>">
                <li class="<?php if('rechargeguide' == 'about'){ echo 'active';} ?>">
                ...
                <li class="<?php if('rechargeguide' == 'newuserzc'){ echo 'active';} ?>">
                ...
                <!--<li class=" ">-->
                    ...
                    <!--</a>-->
                <!--</li>-->
                <li class="<?php if('rechargeguide' == 'helpcenter'){ echo 'active';} ?>">
        ...
        <div class="profile-usermenu " style="margin-top: 0px;">
            ...
            <ul class="nav hidden_nav" style="<?php if($pc == 'notpc'){ echo 'display:block;';} ?>">
                <li class="<?php if('rechargeguide' == 'signupguide'){ echo 'active';} ?>">
                ...
                <li class="<?php if('rechargeguide' == 'rechargeguide'){ echo 'active';} ?>">
                    <a href="index.php?&a=rechargeguide">
                        <!--<i class="icon-settings"></i>-->
                        充值指南
                    </a>
                </li>
                <li class="<?php if('rechargeguide' == 'tradingguide'){ echo 'active';} ?>">
                                                    ...
                                                    <div class="portlet light radius">
                                                        <div class="portlet-title tabbable-line" style="height: 60px;">
                                                            <div class="caption caption-md">
                                                                ...
                                                                <span class="caption-subject font-blue-madison bold uppercase" style="font-size: 20px;padding-left: 0px;">充值指南</span>
                                                            </div>
                                                        ...
                                                        <div class="portlet-body">
                                                            <div class="tab-content">
                                                                ...
                                                                <div class="tab-pane active" id="tab_1_1">
                                                                    ...
                                                                    <p class="dark">充值指南在浏览器地址栏输入www.mobicoin.com，进入mobicoin官网，点击右上角登录注册按钮。目前币创网支持手机注册和邮箱注册。</p>
