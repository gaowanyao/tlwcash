...
//    });
    ...
    <section id="intro-image" class="intro medium clearfix">
        ...
        <div class="intro-captions">
            <h3 class="caption-title big animated"><?php echo ($article["title"]); ?></h3><br>
    ...
    <section id="content">
        ...
        <article class="single-news container">
            ...
            <blockquote>
                <p><span  style="font-weight: 900;font-style: normal;">摘要提示：</span>
            ...
            <div class="caption">
                <a href="<?php echo ($article['article_picture']); ?>" class="imagebox zoom-thumb" title="<?php echo ($article["title"]); ?>">
 ...
 $tag = $article['tag']; $arr = explode(",",$tag); $str = ""; for($i=0;$i<count($arr);$i++){ if($arr[$i] == ''){}else{ $str .='<a class="title_head" style="color:#a0a9b4 !important;margin-right:5px;margin-bottom:5px;display:inline-block;" href="index.php?&a=tag&tag='.$arr[$i].'" >
            ...
            <div class="jiathis_style" style="<?php if($pc=='pc'){ echo 'float: right;';}else{ echo 'float: left;';}?>">
                ...
                <div class="jiathis_style">
                    <span class="jiathis_txt" style="color:#a0a9b4 !important;">分享到：</span>
 ...
 if($display_last == "kong"){ echo "none"; }else{ echo "inline-block"; } ?>
                ;" href="index.php?&a=newsdet&id=<?php echo ($last); ?>" style="display: inherit;">上一篇：<?php echo ($last_title); ?></a>
                <br/>
                <a style="display: <?php
 if($display_next == "kong"){ echo "none"; }else{ echo "inline-block"; } ?>
                ;" href="index.php?&a=newsdet&id=<?php echo ($next); ?>">下一篇：<?php echo ($next_title); ?></a>
