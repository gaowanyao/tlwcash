...
<body class=" login" style="background: transparent !important;">
<!-- BEGIN LOGO -->
<div class="logo">
    <a href="index.html">
        <img style="width: 120px;" src="/Public/img/logo.png" alt="" /> </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content" style="margin-top: 10px;">
    <!-- BEGIN LOGIN FORM -->
    <form class="login-form"  style="<?php if($register == 'on'){ echo 'display:none';}?>" action="index.php?&a=login_msg" method="post">
        ...
        <div class="form-group">
            ...
            <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="用户名/手机号/E-mail" name="username" />
        </div>
    ...
    <form class="forget-form" action="index.php?&a=update_pwd_msg" method="post">
        <h3 class="font-green">忘记密码?</h3>
        <p> 请输入下面的电子邮件地址重新设置密码： </p>
        <div class="form-group">
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn btn-success uppercase pull-right">找回密码</button>
        </div>
    </form>
    <!-- END FORGOT PASSWORD FORM -->
    <!-- BEGIN REGISTRATION FORM -->
    <form class="register-form" style="<?php if($register == 'on'){ echo 'display:block';}?>" action="index.php?&a=register_msg" method="post">
        ...
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">用户名</label>
            <input class="form-control placeholder-no-fix" type="text" autocomplete="off" minlength="2" placeholder="用户名" name="username" />
        </div>
        ...
        <div class="form-group">
            ...
            <input class="form-control form-control-solid placeholder-no-fix" type="tel" minlength="11" autocomplete="off" placeholder="手机号" name="phone" />
        </div>

        <div class="form-group">
            <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
            <label class="control-label visible-ie8 visible-ie9">E-mail</label>
            <input class="form-control form-control-solid placeholder-no-fix" type="email" autocomplete="off" placeholder="E-mail" name="email" />
        </div>
        ...
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">密码</label>
            <input class="form-control placeholder-no-fix" type="password" minlength="6" n autocomplete="off" id="register_password" placeholder="密码" name="password" />
        </div>
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">确认密码</label>
            <input class="form-control placeholder-no-fix" type="password" minlength="6" autocomplete="off" placeholder="确认密码" name="rpassword" />
        </div>
