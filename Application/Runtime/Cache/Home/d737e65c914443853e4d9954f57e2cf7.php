    ...
    <div class="portlet light profile-sidebar-portlet radius">
        ...
        <div class="profile-usermenu" style="margin-top: 0px;">
            ...
            <ul class="nav hidden_nav" style="<?php if($pc == 'notpc'){ echo 'display:block;';} ?>">
                <li class="<?php if('signipguide' == 'about'){ echo 'active';} ?>">
                ...
                <li class="<?php if('signipguide' == 'newuserzc'){ echo 'active';} ?>">
                ...
                <!--<li class=" ">-->
                    ...
                    <!--</a>-->
                <!--</li>-->
                <li class="<?php if('signipguide' == 'helpcenter'){ echo 'active';} ?>">
        ...
        <div class="profile-usermenu " style="margin-top: 0px;">
            ...
            <ul class="nav hidden_nav" style="<?php if($pc == 'notpc'){ echo 'display:block;';} ?>">
                <li class="<?php if('signipguide' == 'signupguide'){ echo 'active';} ?>">
                ...
                <li class="<?php if('signipguide' == 'rechargeguide'){ echo 'active';} ?>">
                    <a href="index.php?&a=rechargeguide">
                        <!--<i class="icon-settings"></i>-->
                        充值指南
                    </a>
                </li>
                <li class="<?php if('signipguide' == 'tradingguide'){ echo 'active';} ?>">
                                                    ...
                                                    <div class="portlet light radius">
                                                        <div class="portlet-title tabbable-line" style="height: 60px;">
                                                            <div class="caption caption-md">
                                                                ...
                                                                <span class="caption-subject font-blue-madison bold uppercase" style="font-size: 20px;padding-left: 0px;">注册指南</span>
                                                            </div>
