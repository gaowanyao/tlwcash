                ...
                <ul class="nav navbar-nav" id="ulChangeColor">
                    ...
                    <!--<li class="nav-item dropdown">-->
                        ...
                        <!--<ul class="dropdown-menu" style="text-align: center;min-width: 130px;">-->
                            ...
                            <!--<li><a class="<?php if('arbitrage' == 'ico'){ echo 'opencolor';}?>"  href="index.php?a=ico"><?php echo (L("_Header_ico")); ?></a></li>-->
                            <!--<li><a class="<?php if('arbitrage' == 'exponential'){ echo 'opencolor';}?>"  href="index.php?a=exponential"><?php echo (L("_Header_exp")); ?></a></li>-->
                            <!--<li><a class="<?php if('arbitrage' == 'arbitrage'){ echo 'opencolor';}?>"  href="index.php?a=arbitrage"><?php echo (L("_Header_arbitrage")); ?></a></li>-->
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu"  style="text-align: center;min-width: 130px;">
                            <li><a class="<?php if('arbitrage' == 'faq'){ echo 'opencolor';}?>" href="index.php?a=faq"><?php echo (L("_Header_help")); ?></a></li>
                            <li><a class="<?php if('arbitrage' == 'about'){ echo 'opencolor';}?>" href="index.php?a=about"><?php echo (L("_Header_about_us")); ?></a></li>
...
<section class="features-video section section-on-bg" style="height: 500px;">
    <div class="container text-center">
        <h2 class="title"><?php echo (L("_arbitrage_banner")); ?></h2>
        ...
        <!--<iframe src="/player.vimeo.com/video/90299717?title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff" width="720" height="405" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>-->
            <?php echo (L("_arbitrage_banner_content")); ?>
        </div><!--//video-container-->
    </div><!--//container-->
</section><!--//feature-video-->

<div class="features-tabbed section blog container" style="padding:0px 0px 10px;margin-top:50px;<?php if($pc!='pc')echo 'margin-top:-35px'?>">
    <div class="row" style="margin: 0px;">
        <div id="blog-mansonry" class="blog-list">
            <!--套利基金4板块开始-->
            <article class="post col-md-6 col-sm-6 col-xs-12" style="">
                <div class="post-inner">
                    ...
                    <div class="row">
                        <div class="" style="text-align: center">
                            <h3><?php echo (L("_arbitrage_number1")); ?><span style="color: crimson">&nbsp;<?php echo (L("_arbitrage_number1_1")); ?></h3>
                        </div>
                    </div>
                    <div class="content" style="margin: 0 auto;width: 260px">
                        <div class="post-entry">
                            <h3 class="post-title my_title DivDis" style=""><?php echo (L("_arbitrage_Date_1")); ?></h3><p class="indent DivDis">2017-09-01</p>
                            <!--<a class="read-more" href="blog-single.html">Read more <i class="fa fa-long-arrow-right"></i></a>-->
                        </div>


                        <div class="post-entry">
                            <h3 class="post-title my_title DivDis"><?php echo (L("_arbitrage_fixed_1")); ?></h3>
                            <p class="indent DivDis">3.650</p>
                            <!--<a class="read-more" href="blog-single.html">Read more <i class="fa fa-long-arrow-right"></i></a>-->
                        </div>
                        <div class="post-entry">
                            <h3 class="post-title my_title DivDis"><?php echo (L("_arbitrage_year_1")); ?></h3><p class="indent DivDis">3.65%</p>
                            <!--<a class="read-more" href="blog-single.html">Read more <i class="fa fa-long-arrow-right"></i></a>-->
                        </div>
                        <div class="post-entry">
                            <h3 class="post-title my_title DivDis"><?php echo (L("_arbitrage_estimate_1")); ?></h3><p class="indent DivDis">200%</p>
                            <!--<a class="read-more" href="blog-single.html">Read more <i class="fa fa-long-arrow-right"></i></a>-->
                        </div>
                        <div class="post-entry">
                            <h3 class="post-title my_title DivDis"><?php echo (L("_arbitrage_yield_1")); ?></h3>
                            <p style="color: red" class="indent DivDis"><?php echo (L("_arbitrage_everyday_1")); ?></p>
                            <!--<a class="read-more" href="blog-single.html">Read more <i class="fa fa-long-arrow-right"></i></a>-->
                        </div>
                        <div class="post-entry">
            ...
            <article class="post col-md-6 col-sm-6 col-xs-12" style="">
                <div class="post-inner">
                    ...
                    <div class="row">
                        <div class="" style="text-align: center">
                            <h3><?php echo (L("_arbitrage_number_2")); ?><span style="color: crimson">&nbsp;<?php echo (L("_arbitrage_number_2_2")); ?></h3>
                        </div>
                    </div>

                    <div class="content" style="margin: 0 auto;width: 260px">
                        <div class="post-entry">
                            <h3 class="post-title my_title DivDis" style=""><?php echo (L("_arbitrage_Date_1")); ?></h3><p class="indent DivDis">2017-10-01</p>
                            <!--<a class="read-more" href="blog-single.html">Read more <i class="fa fa-long-arrow-right"></i></a>-->
                        </div>
            ...
            <article class="post col-md-6 col-sm-6 col-xs-12" style="">
                <div class="post-inner">
                    ...
                    <div class="row">
                        <div class="" style="text-align: center">
                            <h3><?php echo (L("_arbitrage_number_3")); ?><span style="color: crimson">&nbsp;<?php echo (L("_arbitrage_number1_1")); ?></h3>
                        </div>
                    </div>
                    <div class="content" style="margin: 0 auto;width: 260px">
                        <div class="post-entry">
                            <h3 class="post-title my_title DivDis" style=""><?php echo (L("_arbitrage_Date_1")); ?></h3><p class="indent DivDis">2017-11-01</p>
                            <!--<a class="read-more" href="blog-single.html">Read more <i class="fa fa-long-arrow-right"></i></a>-->
                        </div>
            ...
            <article class="post col-md-6 col-sm-6 col-xs-12" style="">
                <div class="post-inner">
                    ...
                    <div class="row">
                        <div class="" style="text-align: center">
                            <h3><?php echo (L("_arbitrage_number_4")); ?><span style="color: crimson">&nbsp;<?php echo (L("_arbitrage_number1_1")); ?></h3>
                        </div>
                    </div>
                    <div class="content" style="margin: 0 auto;width: 260px">
                        <div class="post-entry">
                            <h3 class="post-title my_title DivDis" style=""><?php echo (L("_arbitrage_Date_1")); ?></h3><p class="indent DivDis">2017-12-01</p>
                            <!--<a class="read-more" href="blog-single.html">Read more <i class="fa fa-long-arrow-right"></i></a>-->
                        </div>
                        ...
                        <button id="invest3" type="button" data-dismiss="modal" aria-hidden="true" class="btn btn-cta btn-cta-primary" style="margin-bottom: 25px;font-size: 20px;text-align: center;"><?php echo (L("_ICO_money_3")); ?></button>
...
<!--<div class="sections-wrapper" style="background: #f5f5f5">-->
    ...
    <!--</section>&lt;!&ndash;//why&ndash;&gt;-->

    <!--&lt;!&ndash; ******Testimonials Section****** &ndash;&gt;-->
    <!--&lt;!&ndash;<div style="background:#f5f5f5;width: 100%;height: 30px; "></div>&ndash;&gt;-->
<!--</div>&lt;!&ndash;//section-wrapper&ndash;&gt;-->
...
<!--模态框开始4-->
<div class="row">
    <div  class="modal fade draggable-modal"  id="modal3" tabindex="-1" role="basic" aria-hidden="true">
        <div class="modal-dialog" style="padding: 5px;padding-top:15px ">
            <div class="modal-content">
                <ul id="myTab" class="nav nav-tabs">
                    <li class="active">
