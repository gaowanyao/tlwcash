                                                                    ...
                                                                    <form role="form" action="#" class="form-horizontal" id="form_sample_1">
                                                                        <div class="form-body">
                                                                            ...
                                                                            <div class="form-group form-md-line-input">
                                                                                ...
                                                                                <div class="col-md-9">
                                                                                    <input type="text" value="<?php echo ($user["user_name"]); ?>" disabled class="form-control" placeholder="" name="user_name">
                                                                            ...
                                                                            <div class="form-group form-md-line-input">
                                                                                ...
                                                                                <div class="col-md-9">
                                                                                    <input type="text" value="<?php echo ($user["email"]); ?>" disabled class="form-control" placeholder="" name="email">
                                                                                    <div class="form-control-focus"> </div>
                                                                            ...
                                                                            <div class="form-group form-md-line-input">
                                                                                ...
                                                                                <div class="col-md-9">
                                                                                    <input type="text"  value="<?php echo ($user["phone"]); ?>" disabled class="form-control" placeholder="" name="phone">
                                                                                    <div class="form-control-focus"> </div>
