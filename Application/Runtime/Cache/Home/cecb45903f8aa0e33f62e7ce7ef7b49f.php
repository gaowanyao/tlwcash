...
<head>
    ...
    <meta name="keywords" content="新闻资讯,多宝,金豆,多宝金豆,区块链,数字货币"/>
...
//    });
    ...
    <section id="intro-image" class="intro medium clearfix">
        ...
        <div class="intro-captions">
            <h3 class="caption-title big animated">新闻资讯</h3><br>
            <h3 class="caption-title small animated">多宝金豆新闻资讯每日为您提供最新最全面的市场众筹资讯、行业报道、媒体报道等新闻热点</h3>
        </div>
    ...
    <section id="content"  style="margin-top:-60px;">
        ...
        <section id="news-entries">
            ...
            <?php if(is_array($all)): $i = 0; $__LIST__ = $all;if( count($__LIST__)==0 ) : echo "当前页没有内容" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!-- Entry -->
 ...
 $time = strtotime($vo['create_time']); echo date("M d,Y",$time); ?>
                            ...
                            <div class="categories"><a href="#"><?php echo ($vo["author"]); ?></a></div>
                        </div>

                        <div class="col-2-3 last">
                            <h2 class="entry-title"><a href="index.php?a=newsdet&id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></h2>
                            <!--<p class="excerpt">-->
                            ...
                            <div class="animated" data-delay="100" style="height:100px;overflow: hidden;"><?php echo ($vo['content']); ?></div>


                            <span class=" animated"  style="color:#a0a9b4 !important;font-size: 16px;padding-bottom: 10px;" data-delay="150">标签：</span><?php
 $tag = $vo['tag']; $arr = explode(",",$tag); $str = ""; for($i=0;$i<count($arr);$i++){ if($arr[$i] == ''){}else{ $str .='<a class="title_head animated" data-delay="200" style="color:#a0a9b4 !important;margin-right:5px;margin-bottom:5px;display:inline-block;" href="index.php?&a=tag&tag='.$arr[$i].'" >
                            ...
                            <div style="display: inline-block;text-align: right;float: right;padding-right: 10px;">
                                <a href="index.php?a=newsdet&id=<?php echo ($vo["id"]); ?>"  class="readmore animated">阅读全文</a>
        ...
        <div id="news_page" style="text-align: center!important; font-size: 20px !important;padding-top:20px;padding-bottom: 40px;width: 100%;">
            <?php echo ($showall); ?>
